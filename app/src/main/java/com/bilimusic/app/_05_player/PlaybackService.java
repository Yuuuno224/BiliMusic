...
import com.bilimusic.app._07_ui.NowPlayingActivity;
...
public class PlaybackService extends MediaSessionService {
    ...
    public void onCreate() {
        ...
        DefaultHttpDataSource.Factory httpFactory =
                new DefaultHttpDataSource.Factory()
                        .setUserAgent(com.bilimusic.app._01_net.BiliHttp.UA)
    ...
    static final class MediaItemBuilder {
        ...
        private static PlayDataAudio resolve(android.content.Context ctx, Song song) throws Exception {
            if (song.cid <= 0) {
                com.bilimusic.app._02_model.ViewData view = com.bilimusic.app._01_net.BiliApi.videoDetail(song.bvid);
                song.cid = view.cid;
                if (song.durationSec <= 0) {
                    song.durationSec = view.duration;
                }
            }
            com.bilimusic.app._02_model.PlayData.AudioStream stream =
                    com.bilimusic.app._01_net.BiliApi.bestAudio(song.bvid, song.cid);
